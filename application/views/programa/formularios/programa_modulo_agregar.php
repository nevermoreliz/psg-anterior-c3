        ...
        <div class="row small">
            <div class="col-md-4">
                <div class="form-group m-b-40">
                    <input type="text" class="form-control text-uppercase" name="nombre_modulo_programa" id="nombre_modulo_programa" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?= isset($modulo[0]['nombre_modulo_programa']) ? $modulo[0]['nombre_modulo_programa'] : '' ?>">
                    <span class="bar"></span>
            ...
            <div class="col-md-4">
                <div class="form-group m-b-40">
                    <input type="text" class="form-control text-uppercase" name="descripcion_modulo_programa" id="descripcion_modulo_programa" onkeyup="javascript:this.value=this.value.toUpperCase()" value="<?= isset($modulo[0]['descripcion_modulo_programa']) ? $modulo[0]['descripcion_modulo_programa'] : '' ?>">
                    <span class="bar"></span>
        ...
        <div class="d-flex flex-row-reverse">
            <div class="col-md-2">
                <button type="button" class="btn btn-rounded btn-block btn-warning btn-sm" data-dismiss="modal" id="cancelar_modulo_programa">Cancelar</button>
            </div>
            <div class="col-md-2">
                <button type="button" class="btn btn-rounded btn-block btn-info btn-sm" id="<?= isset($modulo) ? 'actualizar_modulo_programa' : 'insertar_modulo_programa' ?>" type="submit"><i class="mdi mdi-plus-circle"></i> <?= isset($modulo) ? 'Actualizar Modulo' : 'Adicionar Modulo' ?></button>
            </div>
        </div>
        <?= form_close() ?>