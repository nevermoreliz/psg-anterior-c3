...
$(document).ready(function () {
    $('#insertar_produccion_intelectual_persona').on('click', function (e) {
        // alert('insertar');
        e.preventDefault();
        $.ajax({
                method: 'POST',
                url: '/persona/insertar_produccion_intelectual_persona',
                data: new FormData($('#form_produccion_intelectual_persona')[0]),
            ...
            .done(function (respuesta) {
                if (typeof respuesta.exito !== 'undefined') {
                    $('#modal_campos_produccion_intelectual_persona').modal('hide');
    ...
    $('#actualizar_produccion_intelectual_persona').on('click', function (e) {
        // alert('actualizar');
        e.preventDefault();
        $.ajax({
                method: 'post',
                url: '/persona/actualizar_produccion_intelectual_persona',
                data: new FormData($('#form_produccion_intelectual_persona')[0]),
                // data: $('#form_capacitacion_persona').serialize(),
                // dataType: 'json',
                processData: false,
    ...
    // $('#anio_edicion').bootstrapMaterialDatePicker({
    //     weekStart: 0,
    //     time: false,
    // });
});